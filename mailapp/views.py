...
def send_emails(request):
    csv_file_path = r'C:\Users\bhavy\PycharmProjects\proj1\DjangoProject\DjangoProject\TTM\static\python.csv'
    with open(csv_file_path, 'r') as csvfile:
        ...
        for row in reader:
            ...
            send_mail(
                subject,
                message_body,
                'bhavyavaka7@gmail.com',  # Update with your sender email
                [recipient_email],
                fail_silently=False,
            )
